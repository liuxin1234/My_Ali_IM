...
import com.example.administrator.my_ali_im.IMsample.CustomConversationHelper;
import com.example.administrator.my_ali_im.IMsample.LoginActivity;
import com.example.administrator.my_ali_im.IMsample.LoginSampleHelper;
...
public class FragmentTabs extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("UserContext: "+mIMKit.getUserContext().getLongUserId());
        ...
        mTabHost.addTab(mTabHost.newTabSpec(TAB_CONTACT).setIndicator(indicator),MailListFragment.class, fragmentBundle);

        indicator = getIndicatorView(TAB_TRIBE);
        mTabHost.addTab(mTabHost.newTabSpec(TAB_TRIBE).setIndicator(indicator), MessageFragment.class, fragmentBundle);
